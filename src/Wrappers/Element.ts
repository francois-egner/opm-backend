...
export class Element{
    ...
    */
    ...
    public static async create({name, value, type, section_id, pos_index, session} : Params.Element.create): Promise<Element>{
        ...
        return new Element(elementData.m_id, elementData.name, elementData.value, elementData.type, elementData.pos_index, elementData.section_id)
    }
